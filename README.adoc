...
Now ssh to you pve(proxmox) box, we need 2 pakages to be install here "git" and "dnsmasq".
...
Now lets setup the DNS that is requierd for Openshift installation. There is sample file in the template folder 
